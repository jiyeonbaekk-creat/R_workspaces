...
# 문제풀기
# 119 콜센터에는 10분마다 평균적으로 4통의 장난전화가 걸려온다.
...
l = 4 * 3
k = 6
result = dpois(k, lambda = 1)

# 문제풀어보기
# 한 택배 회사에서 하루 평균 10건의 배송 지연이 발생합니다
# 일주일에 배송 지연이 3건 이하로 발생할 확률을 구해보자.
l = 10 * 7
k = 3
result = ppois(k, lambda = 1) 

# 문제풀어보기 -> 누적분포함수(CDF)
# 다음 중 포아송분포를 적용할 수 있는 실생활 예시가 아닌 것은? 4번
